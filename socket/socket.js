...
io.on('connection', (socket)=>{
    ...
    io.emit('getOnlineUsers', Object.keys(userSocketMap)); // getOnlineUsers ek event hai. Jiska kaam object ki keys me se user id nikal kar online users ko bhejna hai. Jo bi user userSocketMap ki andar hoga vo online hoga.
